...
class ShopService {
  private readonly SHOP_ITEMS: Record<string, Omit<ShopItem, 'stock'>> = {
    ...
    goldenrazz: { id: 'goldenrazz', name: 'Golden Razz', price: 200, icon: '✨', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/golden-razz-berry.png', type: 'berry', category: 'berry', maxStock: 5, effect: { type: 'fill-speed', value: 0.4 }, description: 'Much easier catch' },
    silverpinap: { id: 'silverpinap', name: 'Silver Pinap', price: 150, icon: '🌟', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/silver-pinap-berry.png', type: 'berry', category: 'berry', maxStock: 5, effect: { type: 'candy-multiplier', value: 1.5 }, description: '1.5x candy + easier' },
